(function () {
  function injectWeaponImageZoom() {
    if (document.querySelector("#weapon-image-zoom-style")) {
      return;
    }
  ...
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", injectWeaponImageZoom, { once: true });
  } else {
    injectWeaponImageZoom();
  }

  setTimeout(injectWeaponImageZoom, 250);
})();
