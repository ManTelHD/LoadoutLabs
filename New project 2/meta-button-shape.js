(function () {
  ...
  const css = `
    ...
    html body .tier-first .loadout-subnav-row .secondary-mode-switch .mode-button:hover,html body .tier-first .loadout-subnav-row .secondary-mode-switch .mode-button:focus-visible,html body .tier-first .loadout-subnav-row .content-tab:hover,html body .tier-first .content-tab:focus-visible{border-color:rgba(240,173,55,.42)!important;color:var(--text)!important}
    ...
    html body .meta-side-ad em:before{font-size:.8rem!important}
